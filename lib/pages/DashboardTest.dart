...
List<Widget> _tiles = const <Widget>[
  const _Example01Tile(Color(0xff26cb3c) ,Icons.account_balance,),
  const _Example02Tile(Color(0xffff3266), Icons.attach_money),
...
class DashboardPageTest extends StatelessWidget {
